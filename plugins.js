...
if (!isNaN(price) && !isMobile()) {
	let usersNum = getAllUsersCount(), //Users on site during a day
		...
		user = userArray[0],
		leadText1 = leadPluginText[params.lang][1], //с города
		leadText2 = leadPluginText[params.lang][2], //Упаковок заказано
	...
	function getStrLeadInfo() {
		...
		return user +' '+ leadText1 + ' ' + city + '. ' + leadText2 + ': ' + boughtNow + '. ' + leadText3 + ': ' + evaluateSum + '&nbsp;' + currency;
	};
	// lead popup wrapper
